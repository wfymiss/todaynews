package com.xykj.fgy.selector.timeview;
...
public class PowerDateUtils {
    ...
    public static String getDateStr1(int year, int month) {
        long time = componentTimeToTimestamp1(year, month);
        return Date22String(time);
    }
    ...
    public static long componentTimeToTimestamp1(int year, int month) {
    ...
    public static String Date22String(long time) {
        if (time == 0) {
            return "";
        }
        return DateFormat.format("yyyy年MM月", time).toString();
    }
